This is, very simply, a fork of the Gnosis MultiSig Wallet, widely considered to be a very stable and secure implementation of a multisig.

I went on to add various functions that I had been told would be needed.

Soon I saw that we would probably need a specialized single-user interface that could monitor reputation. I had just started fleshing out a skeleton when the project was pulled.
